...
package os.morning.app.adapter;
...
public class MainSectionedListAdapter extends BaseAdapter {
    ...
    public MainSectionedListAdapter(Context context, int sectionResourceId,
